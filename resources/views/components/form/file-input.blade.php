...
>
    ...
    <div
        class="flex w-full flex-col items-center justify-center gap-2 rounded-md border border-dashed border-neutral-300 p-8 text-neutral-600 dark:border-neutral-700 dark:text-neutral-300">
        ...
        <div class="group">
            <label for="fileInputDragDrop"
                ...
                /> Browse </label> or drag and drop here
        </div>

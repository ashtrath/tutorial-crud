<x-app-layout>
    ...
    <section class="p-8 w-full shadow-md rounded-xl bg-white dark:bg-dark-eval-1 ">
        <header>
            <h2 class="text-lg font-semibold">Create New Social Links</h2>
        </header>
        <form action="{{ route('admin.social_link.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
